...
namespace EnivStudios
{
    public class RaycastItem : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            {
                //These lines handles when camera is not raycasting item
                crosshairColorChange = false; itemUI.crosshair.color = Color.white; itemUI.examineKeyBG.SetActive(false); itemUI.interactKeyBG.SetActive(false);
                Back();
            }
